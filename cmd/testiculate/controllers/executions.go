...
// GetExecutionsByService fetches the last 30 days of individual test executions
//   Request -> Response<[]Execution>
func (c *Context) GetExecutionsByService(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
